...
export const BCA_SCENARIOS: BcaScenario[] = [
  {
    ...
    expectReviewRequired: false,
    expectedAlerts: 0,
    csv: `${BCA_HEADER}\nMCH-OUTLET-042,Acme Facilities Tampines Hub,Retail,2025-01-01,2025-12-31,3200,108.5,0.61,13.2,380.0,Platinum,BCA`,
  },
  {
    id: "BC2",
    label: "EUI data missing",
    buildingName: "Acme Facilities — Woodlands CC",
    outletId: "MCH-OUTLET-017",
    description: "EUI not recorded. EUI_DATA_PRESENT alert expected.",
    expectReviewRequired: true,
    expectedAlerts: 1,
    csv: `${BCA_HEADER}\nMCH-OUTLET-017,Acme Facilities Woodlands CC,Retail,2025-01-01,2025-12-31,2800,,0.63,14.1,395.0,Platinum,BCA`,
  },
  {
    id: "BC3",
    label: "Audit period missing",
    buildingName: "Acme Facilities — Jurong West",
    outletId: "MCH-OUTLET-033",
    description: "Period dates not set. Two MEDIUM alerts expected.",
    expectReviewRequired: true,
    expectedAlerts: 2,
    csv: `${BCA_HEADER}\nMCH-OUTLET-033,Acme Facilities Jurong West,Retail,,,2950,112.0,0.64,14.8,402.0,Gold+,BCA`,
  },
];
